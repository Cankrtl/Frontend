...
movieStars.forEach((movieStar, index, arr) => {
  console.log(movieStar, index, arr);
});

const popStars = ["Tarkan", "Bengü", "Demet", "Gülşen"];

popStars.forEach((popStars, index) => {
  console.log(popStars, index);
});
...
createDoubles(NumbersArr2);

console.log(createDoubles(NumbersArr2));
